...
int main() {
  ...
  // start in lane 1 = left?
  int lane =1;
  // have a referenze velocity to target
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // Create a list of wide spaced (x,y) waypoints around 30m
          vector<double> ptsx;
          vector<double> ptsy;
          ...
          std::cout << ptsx[0] <<" "<< ptsx[1] <<" "<< ptsx[2] 
               <<" "<< ptsx[3] <<" "<< ptsx[4] <<std::endl;
          std::cout << ptsy[0] <<" "<< ptsy[1] <<" "<< ptsy[2] 
               <<" "<< ptsy[3] <<" "<< ptsy[4] << std::endl;
          std::cout << ref_x <<" "<< ref_x <<" "<< car_yaw << std::endl;
          ...
          for (int i = 1; i <= 50-previous_path_x.size(); i++) {
            ...
            double cos_yaw = cos(ref_yaw);
            double sin_yaw = sin(ref_yaw);
            x_point = (shift_x*cos_yaw - shift_y*sin_yaw); 
            y_point = (shift_x*sin_yaw + shift_y*cos_yaw);
            x_point += ref_x; 
            y_point += ref_y;
